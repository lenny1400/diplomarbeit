...
final DatabaseReference ref_user_id = FirebaseDatabase(databaseURL: "https://rocomp-app-d6d31-default-rtdb.europe-west1.firebasedatabase.app/").reference().child("User");
...
void setValuesDatabase(String uid, String myEmail, String myName){
  ...
  final DatabaseReference ref_user_id_child = FirebaseDatabase(databaseURL: "https://rocomp-app-d6d31-default-rtdb.europe-west1.firebasedatabase.app/").reference().child("User").child(uid);
