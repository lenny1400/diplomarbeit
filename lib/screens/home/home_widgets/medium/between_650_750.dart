...
class HomeBet650N750 extends StatefulWidget {
  const HomeBet650N750({Key? key, required this.constraint}) : super(key: key);

  final constraint;

  @override
  _HomeBet650N750State createState() => _HomeBet650N750State();
}

class _HomeBet650N750State extends State<HomeBet650N750> {
  @override
