...
class HomeBet750N800 extends StatefulWidget {
  const HomeBet750N800({Key? key, required this.constraint}) : super(key: key);

  final constraint;

  @override
  _HomeBet750N800State createState() => _HomeBet750N800State();
}

class _HomeBet750N800State extends State<HomeBet750N800> {
  @override
        ...
        child: Container(
          ...
          child:  Column(
            ...
            children: <Widget>[
              ...
              Padding(
                padding: EdgeInsets.only(top: constraintX*0.02,left: constraintX*0.07),
                child: Align(
              ...
              Padding(
                padding: EdgeInsets.only(left: constraintX*0.07, right: constraintX*0.05,top: constraintX*0.015,bottom: constraintX*0.015),
                child: Container(
                  height: constraintX*0.06,
                  width: MediaQuery.of(context).size.width*1,
                  child: Align(
                    alignment: Alignment.center,
              ...
              Padding(
                padding: EdgeInsets.only(left: constraintX*0.04, right: constraintX*0.03,top: constraintX*0.00),
                child: Container(
                  width: MediaQuery.of(context).size.width*1,
